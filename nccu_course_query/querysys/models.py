...
class CourseTeacherTable(models.Model):
    """
    it will have more than one teacher in a course.
    And,teacher could teach more than one course.
    """
    course_token = models.ForeignKey('Course', on_delete=models.CASCADE)
    teacher_token = models.ForeignKey('Teacher', on_delete=models.CASCADE)
...
class CourseTimeTable(models.Model):
    ...
    """
    course_token = models.ForeignKey('Course', on_delete=models.CASCADE)
    time_token = models.ForeignKey('ClassTime', on_delete=models.CASCADE)
